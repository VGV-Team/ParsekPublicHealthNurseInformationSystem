    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        LastLastLogin = c.DateTime(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Relationship_RelationshipId = c.Int(),
                        ContactRelationship_RelationshipId = c.Int(),
                ...
                .ForeignKey("dbo.Relationships", t => t.Relationship_RelationshipId)
                .ForeignKey("dbo.Relationships", t => t.ContactRelationship_RelationshipId)
                ...
                .Index(t => t.ContactRelationship_RelationshipId)
                .Index(t => t.District_DistrictId)
                ...
                c => new
                    {
                        ...
                        BloodVialCount = c.Int(nullable: false),
                        BloodVialColor = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BloodSamples", "PatientWorkOrder_PatientWorkOrderId", "dbo.PatientWorkOrders");
            ...
            DropForeignKey("dbo.Patients", "ContactRelationship_RelationshipId", "dbo.Relationships");
            DropForeignKey("dbo.Patients", "Relationship_RelationshipId", "dbo.Relationships");
            ...
            DropIndex("dbo.BloodSamples", new[] { "PatientWorkOrder_PatientWorkOrderId" });
            ...
            DropIndex("dbo.Patients", new[] { "ContactRelationship_RelationshipId" });
            DropIndex("dbo.Patients", new[] { "Relationship_RelationshipId" });
